...
public class LineQTNode {
	...
	public int h;
	/**
	 * Type of this node. It can be:<br/>
	 * {@code POINTER} has no data in it. It has 4 children<br/>
	 * {@code LEAF} contains an object<br/>
	 * {@code EMPTY} Does not represent anything<br/>
	 * 
	 */
	public byte type;
	/**
	...
	public KLine getIntersectedLine(KLine line) {
		if (!this.nodeSquareIntersects(line))
		{
			return null;
		}
	 ...
	 * if it is {@null}, return a new one.
	 * 
	 * @param node
	 *            the node to be returned if it is not null.
	 * @return
	 */
	...
	private boolean nodeSquareIntersects(KLine line) {
