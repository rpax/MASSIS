...
public class PanAndZoomJPanel extends JPanel {
	 ...
	 * 
	 * @param floor
	 *            The floor that this panel should display
	 * @param building
	 *            the building of the current simulation
	 * @param layers
	 *            a list of {@link FloorMapLayer}. The
	 *            {@link FloorMapLayer#drawIfEnabled(Floor, Graphics2D)} method
	 *            of each one of the elements of the list will be called in
	 *            order, from bottom to top. Example:
	 *            <p>
	 ...
	 * 
	 * @param g
	 *            the {@link Graphics2D} object of this panel
	 */
