...
public abstract class FloorMapLayer {
	 ...
	 * 
	 * @param enabled
	 *            if this layer should be enabled or not. For enabling or
	 *            disabling a layer the method {@link #setEnabled(boolean)}
	 *            should be used.
	 */
	 ...
	 * 
	 * @param f
	 *            the floor to be drawn
	 * @param g
	 *            the graphics object where this layer will be drawn
	 */
	 ...
	 * 
	 * @param enabled
	 *            if this layer should be enabled or disabled.
	 */
