...
public class SimDoor extends SimulationObject implements RoomConnector {
	...
	/**
	 * Iterates over all rooms in this floor and, if they intersect, are added to the connected rooms list.
	 */
	...
	public static class SimDoorState implements JsonState {
