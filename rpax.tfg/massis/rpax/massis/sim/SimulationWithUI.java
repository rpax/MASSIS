...
import rpax.massis.displays.HomeDisplay;
import rpax.massis.displays.buildingmap.BuildingMap;
import rpax.massis.displays.displays3d.HomeDisplay3D;
import rpax.massis.displays.floormap.layers.ConnectionsLayer;
import rpax.massis.displays.floormap.layers.CrowdDensityLayer;
import rpax.massis.displays.floormap.layers.DoorLayer;
import rpax.massis.displays.floormap.layers.PathFinderLayer;
import rpax.massis.displays.floormap.layers.PathLayer;
import rpax.massis.displays.floormap.layers.PeopleIDLayer;
import rpax.massis.displays.floormap.layers.PeopleLayer;
import rpax.massis.displays.floormap.layers.QTLayer;
import rpax.massis.displays.floormap.layers.RadioLayer;
import rpax.massis.displays.floormap.layers.RoomsLabelLayer;
import rpax.massis.displays.floormap.layers.RoomsLayer;
import rpax.massis.displays.floormap.layers.VisibleAgentsLines;
import rpax.massis.displays.floormap.layers.VisionRadioLayer;
import rpax.massis.displays.floormap.layers.WallLayer;
...
public class SimulationWithUI extends GUIState {
	...
	public void start() {
		...
		HomeDisplay displayFrame = new HomeDisplay(
				simulation.building.getHome());
