...
public final class KPolygonUtils {
	...
	public static boolean intersects(KPolygon p1, KPolygon p2) {
		return p1.intersectionPossible(p2) && p1.intersects(p2);
	}
	...
	public static  KPoint[] getBoundaryPointsClosestTo(KPolygon poly, double x, double y,
			int npoints) {
		...
		for (int i = 0; i < npoints; i++)
		{
			...
			res[i] = KPoint.getClosestPointOnSegment(p.x, p.y, pNext.x,
					pNext.y, x, y);
		}
		return res;
	}
