...
public class DrawableTabbedFrame extends javax.swing.JFrame {
	...
	public DrawableTabbedFrame(final DrawableLayer<?>... layers)
	{
		this(new ArrayList<DrawableZone>(), "", layers);
	}
			...
			final DrawableLayer<?>... layers)
	{
		...
		java.awt.EventQueue.invokeLater(new Runnable() {
			...
			public void run()
			{
				 ...
				 */
				DrawableTabbedFrame.this.initiate(drawableZones,
	 ...
	 *            the building
	 * @param layers
	 *            a list of {@link FloorMapLayer} that will be shown in the GUI
	 */
	...
	public void addDrawableZone(final DrawableZone drawableZone)
	{
		...
		final PanAndZoomJPanel panAndZoomJPanel = new PanAndZoomJPanel(
				drawableZone, layers);
		/*
		 * TODO Does NOT work with a GLG2DCanvas (HW acceleration library). It
		 * would be great if in a future this could be done. Seems to be
		 * something related to the machine's configuration, because in theory
		 * it would ba as easy as new GLG2DCanvas(panAndZoomJPanel);
		 */
	...
	private void initComponents()
	{
		...
		// style=\"font-size: x-large;\"><strong><span style=\"font-family:
		// verdana, geneva;\"><span style=\"color: #3366ff;\"> Welcome to
		// Simulation 2D display</span></span></strong></span></p>\n<p><span
		// style=\"font-size: medium; font-family: verdana,
		// geneva;\"><strong><span style=\"color: #3366ff;\"><br
		// /></span></strong></span></p>\n<p style=\"color: #ff0000;\"><span
		// style=\"font-family: verdana, geneva; font-size: medium;\"><span
		// style=\"font-size: large;\"><strong><span style=\"color:
		// #000000;\">Layers</span></strong></span><span
		// style=\"text-decoration: underline; color: #666699;\"><strong><br
		// /></strong></span></span></p>\n<p style=\"color: #ff0000;\"><span
		// style=\"color: #000000; font-size: medium; font-family: verdana,
		// geneva;\"><strong><br /></strong></span></p>\n<p><span
		// style=\"font-family: verdana, geneva; font-size: small;\">The
		// simulation 2D display system is organized in
		// <strong>Layers</strong>.&nbsp;Each layer shows different elements
		// from the simulation.Layers can be be enabled or disabled from the top
		// left Layers menu.</span></p>\n<p><span style=\"font-family: verdana,
		// geneva; font-size: medium;\"><br /></span></p>\n<p><span
		// style=\"font-family: verdana, geneva; font-size:
		// large;\"><strong>Zooming</strong></span></p>\n<p><span
		// style=\"font-size: medium; font-family: verdana,
		// geneva;\"><strong><br /></strong></span></p>\n<p><span
		// style=\"font-size: medium; font-family: verdana, geneva;\"><span
		// style=\"font-size: small;\">You can zoom moving the mouse
		// wheel.</span></span></p>\n<p>&nbsp;</p>\n<p>&nbsp;</p>\n<p><span
		// style=\"font-family: verdana, geneva; font-size:
		// large;\"><strong>Panning</strong></span></p>\n<p><span
		// style=\"font-family: verdana, geneva; font-size:
		// medium;\"><strong><br /></strong></span></p>\n<p><span
		// style=\"font-family: verdana, geneva; font-size: small;\">The display
		// allows moving the map, in a drag'drop fashion. Just click with the
		...
		welcomePanelLayout.setHorizontalGroup(
				welcomePanelLayout.createParallelGroup(
	...
	public static void main(String args[])
	{
		...
		} catch (ClassNotFoundException ex)
		{
			java.util.logging.Logger
					.getLogger(DrawableTabbedFrame.class.getName())
