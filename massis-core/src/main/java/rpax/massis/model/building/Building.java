...
public class Building {
     ...
     */
    public Building(BuildingData buildingData, String resourcesFolder,
            BuildingProgressMonitor progressMonitor)
    {
         ...
         */
        buildingData.getHome().setBasePlanLocked(true);
        /*
         * Initialization
         */
    ...
    /**
     * Same as null null null null     {@link #Building(AbstractSimulation, String, String, BuildingProgressMonitor)
    ...
    {
        this(buildingData, resourcesFolder,
    ...
    public Home getHome()
    {
        return this.buildingData.getHome();
    }
    ...
    {
        return this.buildingData.getMetadataManager().getMetadata(f);
    }
