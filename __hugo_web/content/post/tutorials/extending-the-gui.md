...
In a [previous tutorial][tutorial_3] was introduced the different types of visualization that MASSIS has. In this tutorial we will go deeper into this topic, and we will learn how to extend the default MASSIS layer system.
...
{{< fig "http://i.imgur.com/e0P2XJ5.gif" >}}
...
{{< fig "http://i.imgur.com/Q6mbTo8.gif" >}}
...
{{< fig "http://i.imgur.com/DTBu6RA.gif" >}}
